          ...
          <form onSubmit={handleSubmit} className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <div className="grid gap-3">
                ...
                <Input onChange={handleChange} name='email' id="email" type="email" placeholder="m@example.com" required />
              </div>
              <div className="grid gap-3">
                <div className="flex items-center">
                  <Label htmlFor="password">Password</Label>
                  <Link to="/reset-password" className="ml-auto text-sm underline-offset-2 hover:underline">
              ...
              <div className="text-center text-sm opacity-45">
                Don&apos;t have an account?{" "}
                <span className="underline underline-offset-4 cursor-not-allowed">
                  Sign up
                </span>
              </div>
            </div>
